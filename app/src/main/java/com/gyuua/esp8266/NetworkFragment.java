...
public class NetworkFragment extends Fragment {
    ...
    private static class DownloadTask extends AsyncTask<String, Integer, DownloadTask.Result> {
        ...
        /** modify json format here **/
        public String readJson(InputStream stream)
            ...
            String res = "New York, US\n";
            res += json.getJSONArray("weather").getJSONObject(0).getString("description");
            res += '\n';
            res += json.getJSONObject("main").getString("temp");
            res += "°C";
            return res;
        }
    }
